...
export default function BankerPreviousAppointmentsPage() {
  const {
    actor: banker,
    pastAppointments,
    isLoading,
  ...
  return (
    <main className="min-h-[calc(100vh-74px)] px-6 py-12">
      <div className="mx-auto max-w-6xl space-y-8">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-bold tracking-tight text-slate-900">
                {banker ? `${banker.fullName}'s appointment history` : "Previous appointments"}
              </h1>
              <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">
                View the full record of completed customer appointments across every account.
              </p>
            </div>
        ...
        <AppointmentsSection
          title="All Previous Appointments"
